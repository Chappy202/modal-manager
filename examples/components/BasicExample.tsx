...
export function BasicExample() {
  ...
  const handleOpen = () => {
    console.log('Opening basic example modal');
    open();
    console.log('After open() call - isOpen:', isOpen);
  };
  ...
  return (
    <div className="example-card">
      ...
      <Modal isOpen={isOpen} onClose={close} title="Basic Example">
        <ModalContent id="basic-example">
          {({ currentStep, next, prev, isFirst, isLast }) => {
            console.log('ModalContent render - currentStep:', currentStep);
            return (
              <>
